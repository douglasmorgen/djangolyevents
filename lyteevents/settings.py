...
"""
Django settings for lyteevents project.
...
ALLOWED_HOSTS = ['djangolyevents.herokuapp.com','127.0.0.1']
...
WSGI_APPLICATION = 'lyteevents.wsgi.application'
